...
int domaindata_srv_insert(struct  domain_store *db,char *zone_name,char *domain_name, char *view_name, char * host,uint16_t prio,uint16_t weight,
uint16_t port, uint32_t ttl,uint32_t maxAnswer);
int domaindata_srv_delete(struct  domain_store *db,char *zone_name,char *domain_name, char *view_name, char * host,uint16_t prio,uint16_t weight,
uint16_t port, uint32_t ttl ,uint32_t maxAnswer);
